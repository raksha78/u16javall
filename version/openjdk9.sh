...
sudo update-alternatives --set javac /usr/lib/jvm/jdk/bin/java-9-openjdk-amd64/bin/javac
sudo add-apt-repository ppa:maarten-fonville/ppa
sudo apt-get update
sudo apt-get install icedtea-9-plugin
sudo update-alternatives --set javaws /usr/lib/jvm/jdk/bin/java-9-openjdk-amd64/jre/bin/javaws
